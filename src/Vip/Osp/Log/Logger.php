...
namespace lccong\EasyTBK\Vip\Osp\Log;
...
class Logger {
	...
	private static function init(){
		Logger::$LOG_PATH =  \lccong\EasyTBK\Vip\Osp\Util\PathUtil::getRootPath()."/osp-log/";
	...
	public static function error($msg, $e) {
		...
		if(Logger::$LOG_LEVEL <= Logger::$LOG_LEVEL_ERROR){
			if ($e instanceof \lccong\EasyTBK\Vip\Osp\Exception\OspException){
