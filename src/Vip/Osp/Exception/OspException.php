...
namespace lccong\EasyTBK\Vip\Osp\Exception;
...
// 	}
	...
	public function __construct($returnMessage, $returnCode=\lccong\EasyTBK\Vip\Osp\Exception\OspException::CALLEE_UNKNOWN_EXCEPTION) {
		$this->returnCode = $returnCode;
		$this->returnMessage = $returnMessage;
	}
