	...
	public function read($input){
		...
		while(true){
			...
			if ("storeInfo" == $schemeField){
				...
				$this->storeInfo = new \lccong\EasyTBK\Vip\Request\StoreInfo();
			...
			if ("commentsInfo" == $schemeField){
				...
				$this->commentsInfo = new \lccong\EasyTBK\Vip\Request\GoodsCommentsInfo();
			...
			if ("storeServiceCapability" == $schemeField){
				...
				$this->storeServiceCapability = new \lccong\EasyTBK\Vip\Request\StoreServiceCapability();
